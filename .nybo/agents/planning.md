...
Ad-hoc prompting produces code immediately. This agent ensures you have a reviewed, structured plan before execution begins. The spec becomes a contract that the execution agent follows, and the quality agent verifies against.

## Next Steps

After the spec is approved:
- Activate **nybo-execution** to implement the approved spec autonomously.
