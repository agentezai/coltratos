...
description: |-
  Use this agent to challenge a product idea or feature from a strategic perspective before writing requirements. It asks hard questions about customers, competitors, company fit, and problem validity — then produces a Product Strategy document that feeds into the design-requirement agent.
