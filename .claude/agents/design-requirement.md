...
description: |-
  Use this agent to convert a user feedback, feature idea, or goal into a working prototype first, iterate on it with the user until approved, and then produce a structured requirement document.
